...
_POOL: dict[str, dict[str, list[str]]] = {
    ...
    "opening": {
        "favorable": [
            ...
            "{a}, 초반 정찰에서 이미 상대의 의도를 간파했다!",
            "{a}의 병력 이동이 교과서처럼 정확하다. {b}, 허를 찔렸다.",
            "{a}, 초반 견제로 {b}의 자원 라인을 흔들어 놓는다!",
            "전략적 배치에서 한발 앞선 {a}, 초반 주도권을 완벽히 가져간다.",
        ],
        "unfavorable": [
            ...
            "예상치 못한 {b}의 초반 공세에 {a}가 제대로 대응하지 못한다.",
            "{b}, 초반 정찰을 막아내며 {a}의 빌드 의도를 완전히 차단!",
            "{a}의 확장 타이밍이 늦었다. {b}, 이 기회를 놓치지 않는다.",
        ],
        "close": [
            ...
            "서로의 정찰을 허용하지 않는 팽팽한 탐색전이 이어진다.",
            "초반 자원 격차 없음. 두 선수 모두 후반전에 승부를 건다.",
        ],
    },
    ...
    "midgame": {
        "favorable": [
            ...
            "{a}, 전선을 넓혀 {b}가 집중하지 못하게 만들고 있다!",
            "멀티 컨트롤에서 {a}가 압도적이다. {b}의 자원이 메말라간다.",
            "{b}의 반격 시도를 깔끔하게 차단한 {a}, 이제 결정적 기회를 노린다.",
            "병력 효율에서 {a}가 명백히 앞선다. {b}, 역전의 실마리가 없다.",
        ],
        "unfavorable": [
            ...
            "중반 전투마다 {b}가 한 수 위를 보인다. {a}의 전략 수정이 시급하다.",
            "{a}의 병력이 각개격파 당하고 있다. {b}의 집중 운용이 빛난다!",
            "{b}, 멀티까지 밀어붙이며 {a}를 본진에 가두기 시작한다.",
        ],
        "close": [
            ...
            "두 선수 모두 교전을 피하며 자원 비축에 집중하는 국면.",
            "엎치락뒤치락 교전이 반복된다. 이제 한 번의 큰 교전이 승부를 가를 듯!",
        ],
    },
    ...
    "decisive": {
        "favorable": [
            ...
            "{a}, 압도적인 병력으로 {b}의 마지막 보루를 무너뜨린다!",
            "더 이상의 역전은 없다. {a}, 여유로운 마무리로 세트를 가져간다.",
            "{b}가 GG를 선언한다. {a}의 완벽한 경기였다!",
            "{a}, 마지막 교전에서도 흔들림 없는 컨트롤로 세트를 확정!",
        ],
        "unfavorable": [
            ...
            "{b}, 마지막 순간 기적 같은 반격으로 세트를 가져간다!",
            "{a}의 방심이 화근이었다. {b}, 기회를 놓치지 않고 세트 획득!",
            "누구도 예상 못한 역전! {b}의 집념이 결실을 맺었다.",
        ],
        "close": [
            ...
            "관중이 숨을 죽인 마지막 교전. 찰나의 판단이 명암을 갈랐다.",
            "양 선수의 처절한 마지막 싸움. 운명은 더 냉정한 쪽의 편을 들었다.",
        ],
    },
}
